...
$this->title = 'AGE แยกรายสถานบริการ';
...
$this->params['breadcrumbs'][] = ['label' => 'AGE แยกรายอำเภอ', 'url' => ['rdu/rdu19']];
...
<div class="panel panel-primary">
    <div class="panel-heading">
        <h3 class="panel-title">
            <i class="glyphicon glyphicon-signal"> ร้อยละการใช้ยาปฏิชีวนะในโรคอุจาระร่วงเฉียบพลันในผู้ป่วยนอก</i>
        </h3>
    </div>
    <div class="panel-body">
        ...
        echo Highcharts::widget([
            'options' => [
                'title' => ['text' => ''],
                'xAxis' => [
                    'categories' => new SeriesDataHelper($dataProvider, ['HOSPCODE']),
                    'crosshair' => true,
                ],
                'tooltip' => [
